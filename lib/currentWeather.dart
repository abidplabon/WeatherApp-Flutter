...
import 'package:weatherforecast/models/forcast.dart';
...
//first the "createState" will be called and the "build" function will be called
  State<CurrentWeatherPage> createState() =>
...
Widget forcastViewsHourly(Location location) {
  ...
  return FutureBuilder(
    builder: (context, snapshot) {
      if (snapshot.hasData) {
        Forecast? _forcast = snapshot.data as Forecast?;
        if (_forcast == null) {
          return Text("Error getting weather");
        } else {
          ...
          children: [
            Expanded(
                child: Column(
                    ...
                    mainAxisSize: MainAxisSize.min,
                    children: <Widget>[
                  getWeatherIcon(_weather.icon as String),//////////////////////////////////////////////////////////////////////////////
                  Container(
          ...
          itemBuilder: (BuildContext context, int index) {
            return Container(
                ...
                child: Column(children: [
                  ...
                  getWeatherIcon(_forecast.hourly?[index].icon as String),
                  Text(
          ...
          itemBuilder: (BuildContext context, int index) {
            return Container(
                ...
                child: Row(children: [
                  Expanded(
                      child: Text(
                    "${getDateFromTimestamp(_forcast.daily?[index].dt as int)}",
                    style: TextStyle(fontSize: 14, color: Colors.black),
                  )),
                  Expanded(
                      child: getWeatherIconSmall(_forcast.daily?[index].icon as String)),
                  Expanded(
                      child: Text(
